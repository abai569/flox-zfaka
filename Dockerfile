...
RUN rm -f conf/application.ini install/install.lock install/ka_abai_eu_org.sql install/docker-seed.sql install/docker-data-repair.sql install/docker-product-images.sql \
